					...
					<table>
						...
						<tbody>
							...
							<tr v-else v-for="(item, index) in items.data" :key="index">
								...
								<td v-if="item.type == 1" class="td_format">Objeto Postado</td>
								<td v-else-if="item.type == 2" class="td_format">Objeto Encaminhado</td>
								<td v-else-if="item.type == 3" class="td_format">Objeto Saiu para Entrega</td>
